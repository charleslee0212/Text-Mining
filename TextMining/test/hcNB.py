...
#        AllPositive, globalTest
    ...
    trainData = newPositive
    labels = [1 for i in trainData]

    trainData2 = newNegative
    ...
    x_train, x_test, y_train, y_test  = train_test_split(trainData, labels,  test_size=0.1, random_state=69)
    ...
    # deep copy
    global AllPositive 
    AllPositive = [s for s in x_train if y_train[x_train.index(s)] == 1]  
    ...
    # deep copy
    global AllNegative 
    AllNegative = [ s for s in x_train if y_train[x_train.index(s)] == 0]
    print("len(AllNegative) = " + str(len(AllNegative)))
    
    # deep copy
    global testDocsNegative 
    testDocsNegative = [ s for s in x_test if y_test[x_test.index(s)] == 0]
    print("len(testDocsNegative) = " + str(len(testDocsNegative)))
    
    # deep copy
    global testDocsPositive 
    testDocsPositive = [ s for s in x_test if y_test[x_test.index(s)] == 1]

...
labelPosDocs = [1 for i in positiveDocs]
labelNegDocs = [0 for i in negativeDocs]

# create one large list of the docs (order does not matter)
docs = positiveDocs + negativeDocs
...
featureVectors = posFeatureVectors + negFeatureVectors

x_train, x_test, y_train, y_test  = train_test_split(featureVectors, labels,  test_size=0.1, random_state=1)
